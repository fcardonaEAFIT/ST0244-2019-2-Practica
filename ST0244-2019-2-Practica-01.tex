...
El algoritmo~\ref{alg:unificacion} es una copia del encontrado en el
...
La aplicación $\alpha$ de una sustitición es una operación que está
...
\bibitem{pierce} Pierce, Benjamin C. \emph{Type and Programming
    Languages}. The MIT Press. 2002.

\bibitem{pilato} Pilato, Michael C. Collins-Sussman, Ben. Fitzpatrick,
  Brian W. \emph{Version Control with Subversion}. 2008.

\bibitem{robinson} Robinson, J. Alan. Computational logic: The
  unification computation. \emph{Machine Intelligence}, 6:63-72, 1971.

% \bibitem{louden} Louden, Kenneth C. Lenguajes de
%   programación. Principios y práctica. (2003), 87--91.
